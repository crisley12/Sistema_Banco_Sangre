...
function Header()
{
   ...
   $this->Cell(65, 10, utf8_decode('Especialidad'), 1, 0, 'C', 1);
...
$pdf->Cell(10,15,utf8_decode("Especialidad"),0,0,'L');
$pdf->ln(2);
...
while($row = $resultado->fetch_assoc()){
    $pdf->Cell(8, 10, utf8_decode($row['especialidad_id']), 1, 0, 'C', 0);
    $pdf->Cell(65, 10, utf8_decode($row['especialidad_nombre']), 1, 0, 'C', 1);
    $pdf->Cell(52, 10, $row['especialidad_fregistro'], 1, 0, 'C', 1);
    $pdf->Cell(65, 10, $row['especialidad_estatus'], 1, 0, 'C', 1);
    $pdf->Ln();
  }
