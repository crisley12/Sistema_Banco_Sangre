...
function Header()
{
    ...
    $this->Cell(32, 10, 'Stock', 1, 0, 'C', 1);
    $this->Cell(50, 10, 'Fecha de registro', 1, 0, 'C', 1);
    $this->Cell(50, 10, utf8_decode('Fecha de vencimiento'), 1, 1, 'C', 1);
...
$pdf->Cell(10,15,utf8_decode("Medicamentos"),0,0,'L');
$pdf->ln(2);
...
while($row = $resultado->fetch_assoc()){
    $pdf->Cell(8, 10, $row['medicamento_id'], 1, 0, 'C', 0);
    $pdf->Cell(50, 10, $row['medicamento_nombre'], 1, 0, 'C', 1);
    $pdf->Cell(32, 10, $row['medicamento_stock'], 1, 0, 'C', 1);
    $pdf->Cell(50, 10, $row['medicamento_fregistro'], 1, 0, 'C', 1);
    $pdf->Cell(50, 10, $row['medicamento_fechf'], 1, 1, 'C', 1);
}
