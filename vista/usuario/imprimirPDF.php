...
$consulta = "SELECT usuario.usu_id, usuario.usu_nombre, usuario.usu_contrasena, usuario.usu_sexo, rol.rol_nombre AS rol, usuario.usu_estatus, usuario.usu_email, usuario.usu_intento 
...
function Header()
{
   ...
   $this->Cell(32, 10, utf8_decode('Usuario'), 1, 0, 'C', 1);
   $this->Cell(80, 10, 'E-mail', 1, 0, 'C', 1);
   $this->Cell(50, 10, 'Rol', 1, 0, 'C', 1);
   $this->Cell(21, 10, utf8_decode('Sexo'), 1, 1, 'C', 1);
...
$pdf->Cell(10,15,utf8_decode("Usuarios"),0,0,'L');
$pdf->ln(2);
...
while($row = $resultado->fetch_assoc()){
    ...
    $pdf->Cell(8, 10, $row['usu_id'], 1, 0, 'C', 0);
    $pdf->Cell(32, 10, $row['usu_nombre'], 1, 0, 'C', 1);
    $pdf->Cell(80, 10, $row['usu_email'], 1, 0, 'C', 1);
    $pdf->Cell(50, 10, $row['rol'], 1, 0, 'C', 1);
    $pdf->Cell(21, 10, $row['usu_sexo'], 1, 1, 'C', 1);
}
