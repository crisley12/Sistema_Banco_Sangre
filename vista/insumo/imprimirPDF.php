...
$pdf->Cell(10,15,utf8_decode("Insumos"),0,0,'L');
$pdf->ln(2);
...
while($row = $resultado->fetch_assoc()){
    ...
    $pdf->Cell(8, 10, $row['insumo_id'], 1, 0, 'C', 0);
    $pdf->Cell(50, 10, $row['insumo_nombre'], 1, 0, 'C', 1);
    $pdf->Cell(32, 10, $row['insumo_stock'], 1, 0, 'C', 1);
    $pdf->Cell(50, 10, $row['insumo_fregistro'], 1, 0, 'C', 1);
    $pdf->Cell(50, 10, $row['insumo_fechf'], 1, 1, 'C', 1);
}
