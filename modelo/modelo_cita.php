<?php 
	class Modelo_Cita{
		...
		function Registrar_Cita($idpaciente,$iddoctor,$descripcion,$idusuario,$especialidad){
			$sql = "call SP_REGISTRAR_CITA('$idpaciente','$iddoctor','$descripcion','$idusuario','$especialidad')";
			if ($consulta = $this->conexion->conexion->query($sql)) {
